<?php
require_once LH_INC . '/custom_post_type.php';
...
function ele_get_post_types() {
	...
	return array(
        ...
        'references' => array(
            'singular' => 'Reference',   // название для одной записи этого типа   
            'multiple' => 'References',  // основное название для типа записи         
...
*/    
    ...
    if( $current_template  === "page-home.php" ) {
        ...
        $meta_boxes[] = array(
            ...
            'fields'        => array(
                ...
                array(
                    'name'        => 'id ',
                    'label_description' => 'уникальное имя для создания ссылки в меню',
                    'id'          => $prefix . 'whyBest_id',
                    'type'        => 'text',
                    // Placeholder
                ...
                array(
                    'name'        => 'Кому отправить',
                    //'label_description' => 'Label description',
                    'id'          => $prefix . 'form_email_to',
                    'type'        => 'text',
                    // Placeholder
                    'placeholder' => 'Email получателя письма',
                    'size'        => 100,
                ),
                array(
                    'name'        => 'id ',
    ...
    $meta_boxes[] = array(
        'id'            => $prefix . 'reference_settings',
        'title'         => 'Reference настройка отзыва',
        'post_types'    => array( 'references' ),
        'context'       => 'form_top',
        'priority'      => 'high',
        'autosave'      => 'false',
        'fields'        => array(
