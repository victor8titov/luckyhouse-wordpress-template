...
<section class="bg-light page-section block-cards_more_info" id="<?php echo lh_get_meta_box('groupCompaines_id'); ?>">
    <div class="container">
		<div class="row">
			...
			<?php if ( !empty( lh_get_meta_box('groupCompaines_heading') ) ): ?>
			<h2 class="section-heading text-uppercase"><?php echo lh_get_meta_box('groupCompaines_heading'); ?></h2>
			<?php endif; ?>
			<?php if (!empty( lh_get_meta_box('groupCompaines_subtitle') )): ?>
			<h3 class="section-subheading text-muted mb-0"><?php echo lh_get_meta_box('groupCompaines_subtitle'); ?></h3>
			<?php endif; ?>
			</div>
      	</div>
      	<div class="row">
